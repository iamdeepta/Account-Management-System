...
/*switch(isset($_POST))
        {
            ...
            if($_SESSION['OfficeID']==""){
              include 'experience_info_all.php';
            }else{
              include 'experience_info.php';
            }
